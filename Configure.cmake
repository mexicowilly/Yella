...
# Cap'n Proto
FIND_PROGRAM(YELLA_CAPNP
             capnp
             PATHS "${CAPNP_PATH}")
FIND_PATH(YELLA_CAPNP_C_INCLUDE_DIR capnp_c.h PATHS "${CAPNP_C_INCLUDE_DIR}")
IF(NOT YELLA_CAPNP_C_INCLUDE_DIR)
    MESSAGE(FATAL_ERROR "Set CAPNP_C_INCLUDE_DIR")
ENDIF()
FIND_LIBRARY(YELLA_CAPNP_C_LIB capnp_c PATHS "${CAPNP_C_LIB_DIR}")
IF(NOT YELLA_CAPNP_C_LIB)
    MESSAGE(FATAL_ERROR "Set CAPNP_C_LIB_DIR")
ENDIF()
