...
static int set_up(void** arg)
{
    ...
    yella_settings_set_dir(u"agent", u"data-dir", u"saved-state-data");
    yella_remove_all(yella_settings_get_dir(u"agent", u"data-dir"));
    yella_ensure_dir_exists(yella_settings_get_dir(u"agent", u"data-dir"));
    return 0;
}
