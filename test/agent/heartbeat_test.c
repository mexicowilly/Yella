...
static void simple(void** targ)
{
    ...
    yella_push_back_ptr_vector(in->configs, sdsnew("config 9"));
    yella_push_back_ptr_vector(in->configs, sdsnew("config 10"));
    yella_push_back_ptr_vector(in->configs, sdsnew("config 11"));
    yella_push_back_ptr_vector(plg->in_caps, in);
    in = yella_create_plugin_in_cap("sweet", 4, NULL);
    yella_push_back_ptr_vector(in->configs, sdsnew("config 12"));
    yella_push_back_ptr_vector(in->configs, sdsnew("config 13"));
    yella_push_back_ptr_vector(plg->in_caps, in);
    in = yella_create_plugin_in_cap("grumpy", 5, NULL);
    yella_push_back_ptr_vector(in->configs, sdsnew("config 14"));
    yella_push_back_ptr_vector(plg->in_caps, in);
    ...
    yella_push_back_ptr_vector(in->configs, sdsnew("config 17"));
    yella_push_back_ptr_vector(in->configs, sdsnew("config 18"));
    yella_push_back_ptr_vector(in->configs, sdsnew("config 19"));
    yella_push_back_ptr_vector(plg->in_caps, in);
